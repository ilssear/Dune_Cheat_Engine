...
from ct_common import (decode_ce_base85,compress_and_encode_file_with_size,
                       custom_sort_key)
...
SCRIPT_FILES_DIR = ['C_Files', 'ScriptFiles']
...
def merge_files_dic(base_dir: str, custom_dir: str, sub_dirs: list or str) -> list:
    """Merge files from base and custom directories, with custom files taking precedence.
...
def add_script_files_to_xml(files_element: etree.Element, base_dir: str, custom_dir: str, sort_method: str) -> None:
    ...
    """
    merged_files = merge_files_dic(base_dir, custom_dir, SCRIPT_FILES_DIR)
...
def main() -> None:
    ...
    # don't check / create directories. Just flag errors through logging
